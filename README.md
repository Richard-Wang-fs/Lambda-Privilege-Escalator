...
| **Privilege_Escalator** | A legacy admin role kept “just in case” for emergencies, often with permissions like`iam:AttachRolePolicy`. These roles are dangerous if trusted too openly, especially by DevOps teams without time-limited or condition-scoped trust.      |
